...
public class ErrorDao {
	...
	private static final String CONDITION_RULE_DATE = " WHERE id_rule = ? AND " + CONDITION_DATE;
	...
	private static final String SELECT_BY_RULE_DATE = SIMPLE_SELECT + CONDITION_RULE_DATE + ";";
