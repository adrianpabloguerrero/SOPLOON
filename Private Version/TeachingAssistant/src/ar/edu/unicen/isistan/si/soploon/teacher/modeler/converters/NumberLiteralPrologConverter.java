...
public class NumberLiteralPrologConverter extends NodeConverter<NumberLiteral> {

	private static final String KEY = "number_literal";
	private static final String[] KEYS = new String[] { null, "parent", "value", "body_declaration",
			"type_declaration", "compilation_unit" };

	public NumberLiteralPrologConverter(Mapper mapper, PrologCode code, NodeConverterFactory converter_factory) {
		super(mapper, code, converter_factory);
	}

	@Override
	public void convert(NumberLiteral node) {
	...
	@Override
	public void bind(NumberLiteral node) {
