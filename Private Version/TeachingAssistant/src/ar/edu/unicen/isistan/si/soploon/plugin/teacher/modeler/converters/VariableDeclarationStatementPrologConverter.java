...
public class VariableDeclarationStatementPrologConverter extends NodeConverter<VariableDeclarationStatement> {
	...
	public VariableDeclarationStatementPrologConverter(Mapper mapper, PrologCode code,
	...
	@Override
	public void convert(VariableDeclarationStatement node) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public void bind(VariableDeclarationStatement node) {
