package teachingassistant.handlers;
...
import teachingassistant.analyzer.PrologAnalyzer;
import teachingassistant.analyzer.RuleSet;
...
public class UpdateHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) {
		String rulesxml = getURL("http://intranet.isistan.unicen.edu.ar:8081/Rules/rules.xml");
		...
		if (local_rules == null || !local_rules.getVersion().equals(remote_rules.getVersion())) {
			String basic = getURL("http://intranet.isistan.unicen.edu.ar:8081/Rules/basic_knowledge.pl");
			String specific = getURL("http://intranet.isistan.unicen.edu.ar:8081/Rules/specific_knowledge.pl");
			String rules = getURL("http://intranet.isistan.unicen.edu.ar:8081/Rules/rules_knowledge.pl");
